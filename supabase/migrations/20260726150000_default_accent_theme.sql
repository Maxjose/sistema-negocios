...
alter table public.businesses
  drop constraint if exists businesses_accent_theme_check;

alter table public.businesses
  add constraint businesses_accent_theme_check
  check (accent_theme in ('default', 'emerald', 'blue', 'violet', 'rose', 'amber', 'cyan'));
...
begin
  if p_accent_theme not in ('default', 'emerald', 'blue', 'violet', 'rose', 'amber', 'cyan') then
