...
export function ReportView({ report, previous, compact = false, detailed = false, useStock = true }: { report: BusinessReport; previous: BusinessReport; compact?: boolean; detailed?: boolean; useStock?: boolean }) {
