...
export function CustomerCreateDialog() {
  ...
  return <>
    <button className="inline-flex min-h-10 w-full items-center justify-center gap-1.5 rounded-xl bg-brand px-2 text-xs font-bold text-white transition hover:brightness-95 sm:min-h-11 sm:w-auto sm:gap-2 sm:px-4 sm:text-sm" onClick={() => setOpen(true)} type="button"><Plus className="size-4" /> Agregar cliente</button>
