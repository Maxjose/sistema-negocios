...
export default async function ReportsPage({
  ...
  return <div><div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-end"><div><p className="text-sm text-muted">Análisis de ventas, productos e inventario</p><h2 className="mt-1 text-2xl font-bold">Reportes</h2></div><PeriodFilter from={range.from} period={range.period} to={range.to} /></div><div className="mt-7"><ReportView detailed previous={previous} report={report} /></div></div>;
}
